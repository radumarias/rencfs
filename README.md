...
6. `RUSTFLAGS: "-Dwarnings"` set this before you run `cargo` commands, one time per terminal or add it to your `rc` file
7. `cargo build --all --all-features` and fix any issues
